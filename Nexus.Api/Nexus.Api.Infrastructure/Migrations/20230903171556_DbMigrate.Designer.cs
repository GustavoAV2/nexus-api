...
namespace Nexus.Api.Infrastructure.Migrations
{
    ...
    [Migration("20230903171556_DbMigrate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nexus.Api.Domain.Entities.UserRelation", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Nexus.Api.Domain.Entities.UserRelation", b =>
                {
                    b.HasOne("Nexus.Api.Domain.Entities.User", "FollowedUser")
                        .WithMany()
                        .HasForeignKey("FollowedUserId");

                    b.HasOne("Nexus.Api.Domain.Entities.User", "FollowingUser")
                        .WithMany()
